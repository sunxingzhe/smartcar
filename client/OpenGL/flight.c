...
static int request_hm_addr()
{
    ...
    rcv_msg->code = MC_REQUEST_HM_ADDR;
...
int main(int argc, char** argv)
{
    ...
    pthread_create(&net_thread, NULL, &net_process, NULL);
